          ...
          <div className="row gy-4">
            ...
            <div className="col-lg-2 col-6 footer-links">
              ...
              <ul>
                ...
                <li>
                  <i className="bi bi-chevron-right" /> <a href="#">Terms of service</a>
                </li>
                <li>
            ...
            <div className="col-lg-2 col-6 footer-links">
              ...
              <ul>
                ...
                <li>
                  <i className="bi bi-chevron-right" /> <a href="#">Web Development</a>
                </li>
                <li>
                  <i className="bi bi-chevron-right" /> <a href="#">Product Management</a>
                </li>
                <li>
                  <i className="bi bi-chevron-right" /> <a href="#">Marketing</a>
                </li>
                <li>
                  <i className="bi bi-chevron-right" /> <a href="#">Graphic Design</a>
                </li>
              </ul>
            </div>
