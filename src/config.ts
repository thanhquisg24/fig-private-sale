...
export const FIG_CHAIN: Chain = {
  ...
  getExplorerAddressLink: (address: string) => `https://agnek.fichain.org/address/${address}`,
  getExplorerTransactionLink: (transactionHash: string) => `https://https://agnek.fichain.org/tx/${transactionHash}`,
  // Optional parameters:
